...
describe("C605839-Finnish Edition", () => {
...
it("Select Finnish Edition", () => {
   accept.getFinnishEdition().click()
})
...
// Select Finnish module filter
it("Select Finnish module filter", () => {
    searchpage.getFinnishModuleFilter()
})
...
it("Load the first result", () => {
    ...
    if(cy.get('#home-attributes-fh-cd1_canvas > h4').should('contain', 'Finnish module'))
    {
...
it("Click the details tab", () => {
    ...
    detailspage.getDetailsTab(data.FinnishEditionConceptDetailsTab)
    })
})
