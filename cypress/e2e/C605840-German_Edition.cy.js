...
describe("C605840-German Edition", () => {
...
it("Select German Edition", () => {
   accept.getGermanEdition().click()
})
...
it("Search module and verify the search result", () => {
   ...
   searchpage.getValidateSearchResult(data.GermanyEditionSearchResult)
   })
})
...
// Select German module filter
it("Select German module filter", () => {
    searchpage.getGermanModuleFilter()
})
...
it("Load the first result", () => {
    ...
    if(cy.get('#home-attributes-fh-cd1_canvas > h4').should('contain', ' German module'))
    {
...
it("Click the details tab", () => {
    ...
    detailspage.getDetailsTab(data.GermanyEditionConceptDetailsTab)
    })
})
