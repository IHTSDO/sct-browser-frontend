...
describe("C605836-Canadian Edition", () => {
...
it("Select Canadian Edition", () => {
   accept.getCanadianEdition().click()
})
...
it("Select Belgian module filter", () => {
    searchpage.getCanadaHealthInfowayFrechModuleFilter()
})
...
it("Load the first result", () => {
    ...
    if(cy.get('#home-attributes-fh-cd1_canvas > h4').should('contain', ' Modulated (qualifier value)'))
    {
