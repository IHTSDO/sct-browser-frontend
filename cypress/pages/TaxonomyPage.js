...
getTaxonomyTab(){
    ...
    if(cy.get('#fh-taxonomy_canvas-panelTitle > strong > .i18n').should('have.text', 'Taxonomy'))
      {
         return cy.log('Taxonomy page is displayed');
      }
 }
...
getAbormalBloodOxygenNoChild(){
   ...
   cy.get('#fh-taxonomy_canvas-treenode-123821009').should('exist'))
   {
...
getTurnDescendantsCountValue(){
   if(cy.get('#fh-taxonomy_canvas-treenode-404684003').should('contain', '120788'))
   {
